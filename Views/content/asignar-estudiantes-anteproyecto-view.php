...
<form class="user-form mt-5 mb-5 FormulariosAjax" action="<?= SERVERURL ?>Ajax/AnteproyectoAjax.php" method="POST" data-form="save" autocomplete="off">
  ...
  <div class="container-header-form">
    <h2><i class="fas fa-book"></i> Información básica anteproyectos y usuario </h2>
  ...
  <div class="form-grid two mt-5">
    ...
    <input type="hidden" name="id_programa_user" value="<?= $ins_loginControlador->encryption($Programa) ?>">

    <div class="form-floating">
      <input type="number" class="form-control input_border" id="codigo_anteproyecto_regAsig"
        name="codigo_anteproyecto_regA" placeholder="Codigo anteproyecto"  onchange="BuscarProyecto(this.value, '<?= SERVERURL ?>')">
      <label for="codigoAnteproyecto">Código anteproyecto</label>
    </div>
    <div class="form-floating">
      <input type="text" class="form-control input_border" id="numero_documento_regA"
        name="numero_documento_regA" placeholder="Numero de documento" onchange="BuscarUsuario(this.value, '<?= SERVERURL ?>')">
    ...
    <div class="form-floating">
      ...
      <label for="tituloProyecto">Título del anteproyecto</label>
    </div>
  ...
  <div class="form-actions mt-5 mb-5">
    <button type="submit"><i class="fa-regular fa-floppy-disk"></i> &nbsp; Asignar estudiante al anteproyecto</button>
  </div>
</form>
