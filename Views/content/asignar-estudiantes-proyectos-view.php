...
<form class="user-form mt-5 mb-5 FormulariosAjax" action="<?= SERVERURL ?>Ajax/ProyectoAjax.php" method="POST" data-form="save" autocomplete="off">
  ...
  <h2><i class="fas fa-book"></i> Información básica proyectos y usuario </h2>
  ...
  <div class="form-grid two mt-5">
    ...
    <input type="hidden" name="privilegio_user_logueado" value="<?= $ins_loginControlador->encryption($_SESSION['privilegio']) ?>">

    <div class="form-floating">
      <input type="number" class="form-control input_border" id="codigo_proyecto_regAsig"
        name="codigo_proyecto_regAsig" placeholder="Codigo anteproyecto" onchange="BuscarProyecto(this.value, '<?= SERVERURL ?>')">
