...
if ($_SESSION['privilegio'] != 5  && $_SESSION['privilegio'] != 4 
    ...
    <div class="row">
        <div class="col-9">
            ...
            if ($resultado_documentos->rowCount() > 0) {
                $nombre_carpeta = SERVERURL . 'Views/document/proyectos/' . $codigo;
        ...
        ?>
            <div class="col-3 ">
                <form class="mt-1 mb-5 FormulariosAjax" action="<?= SERVERURL ?>Ajax/ProyectoAjax.php" method="POST" data-form="save" autocomplete="off">
                    ...
                    <input type="hidden" name="id_retrolimentacion_editar_proyecto" value ="<?= $ins_loginControlador->encryption($id) ?>">
            ...
            ?>
                <div class="col-3 ">
                    <form class="user-form-two mt-1 mb-5 FormulariosAjax" action="<?= SERVERURL ?>Ajax/ProyectoAjax.php" method="POST" data-form="save" autocomplete="off">
