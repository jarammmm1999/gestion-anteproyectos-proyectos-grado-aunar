...
<form class="user-form mt-5 mb-5 FormulariosAjax" action="<?= SERVERURL ?>Ajax/ProyectoAjax.php" method="POST" data-form="save" autocomplete="off">
    <h2><i class="fas fa-book"></i> Información básica Proyectos</h2>

    <div class="form-grid  mt-5">

        <div class="input-group">
            <div class="form-floating">
                <input type="number" class="form-control input_border" id="floatingDocumento" name="codigo_proyecto_reg" placeholder="Numero de documento" readonly>
                <label for="floatingDocumento">Codigo Proyecto</label>
            </div>
            <button class="btn " type="button" id="buscarAnteproyecto">Generar</button>
        </div>

        <div class="form-floating">
            <input type="text" class="form-control input_border" id="floatingNombre" name="titulo_proyecto_reg" placeholder="Password">
            <label for="floatingNombre mb-4">Título  de Proyecto</label>
        </div>

        <div class="form-floating">
            <input type="text" class="form-control input_border" id="floatingNombre" name="palabras_claves_proyecto_reg" placeholder="Password">
    ...
    <div class="form-actions mt-5 mb-5">
        <button type="submit"><i class="fa-regular fa-floppy-disk"></i> &nbsp; Registrar proyecto</button>
    </div>
</form>
